...
Rails.application.configure do
  ...
  config.assets.precompile += %w( *.woff *.woff2 *.eot *.ttf *.svg )
  ...
  config.session_store :cookie_store, key: 'cookie_session_key', secure: Rails.env.production?, same_site: :lax
  ...
  # config.active_job.queue_name_prefix = "claude_app_production"
